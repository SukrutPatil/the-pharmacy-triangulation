...
const address_entity_1 = require("../model/address.entity");
const article_entity_1 = require("../model/article.entity");
const chat_entity_1 = require("../model/chat.entity");
const drug_entity_1 = require("../model/drug.entity");
...
let DatabaseService = DatabaseService_1 = class DatabaseService {
    constructor() {
        this.db = pgp({})({
            user, host, database, password, port: +dbport
        });
        this.self = this;
